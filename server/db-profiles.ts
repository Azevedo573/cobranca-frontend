...
export const MODULOS = [
  ...
  { id: "juridico",       label: "Jurídico",             grupo: "Jurídico" },
...
export const PERFIS_PADRAO = [
  ...
  },
  {
    ...
    permissoes: ["dashboard:visualizar", "condominios:visualizar", "devedores:visualizar", "devedores:editar",
      ...
      "relatorios:exportar", "automacao:visualizar", "juridico:visualizar", "juridico:criar", "juridico:editar",
      "usuarios:visualizar"],
  },
  {
    nome: "Operador",
  ...
  },
  {
    ...
    permissoes: ["dashboard:visualizar", "devedores:visualizar", "cobrancas:visualizar",
      "juridico:visualizar", "juridico:criar", "juridico:editar", "juridico:aprovar", "relatorios:visualizar"],
  },
  {
    nome: "Síndico",
    ...
    cor: "#06b6d4",
    permissoes: ["dashboard:visualizar", "devedores:visualizar", "cobrancas:visualizar",
      "acordos:visualizar", "juridico:visualizar", "juridico:criar"],
  },
] as const;
